			...
			<div class="row">
				<div class="col-lg-8 posts-list">
					<div class="single-post row">
						...
						<div class="col-lg-9 col-md-9 ">
							<div class="feature-img">
								<img class="img-fluid" src="<?=base_url('img/blog/feature-img1.jpg')?>" alt="">
							</div>
					...
					<div class="single-post row">
						...
						<div class="col-lg-9 col-md-9 ">
							<div class="feature-img">
								<img class="img-fluid" src="<?=base_url('img/blog/feature-img2.jpg')?>" alt="">
							</div>
					...
					<div class="single-post row">
						...
						<div class="col-lg-9 col-md-9">
							<div class="feature-img">
								<img class="img-fluid" src="<?=base_url('img/blog/feature-img3.jpg')?>" alt="">
							</div>
					...
					<div class="single-post row">
						...
						<div class="col-lg-9 col-md-9">
							<div class="feature-img">
								<img class="img-fluid" src="<?=base_url('img/blog/feature-img4.jpg')?>" alt="">
							</div>
					...
					<div class="single-post row">
						...
						<div class="col-lg-9 col-md-9">
							<div class="feature-img">
								<img class="img-fluid" src="<?=base_url('img/blog/feature-img5.jpg')?>" alt="">
							</div>
				...
				<div class="col-lg-4 sidebar-widgets">
					<div class="widget-wrap">
						...
						<div class="single-sidebar-widget user-info-widget">
							<img src="<?=base_url('img/blog/user-info.png')?>" alt="">
						...
						<div class="single-sidebar-widget popular-post-widget">
							...
							<div class="popular-post-list">
								<div class="single-post-list d-flex flex-row align-items-center">
									<div class="thumb">
										<img class="img-fluid" src="<?=base_url('img/blog/pp1.jpg')?>" alt="">
									</div>
									<div class="details">
								...
								<div class="single-post-list d-flex flex-row align-items-center">
									<div class="thumb">
										<img class="img-fluid" src="<?=base_url('img/blog/pp2.jpg')?>" alt="">
									</div>
									<div class="details">
								...
								<div class="single-post-list d-flex flex-row align-items-center">
									<div class="thumb">
										<img class="img-fluid" src="<?=base_url('img/blog/pp3.jpg')?>" alt="">
									</div>
									<div class="details">
								...
								<div class="single-post-list d-flex flex-row align-items-center">
									<div class="thumb">
										<img class="img-fluid" src="<?=base_url('img/blog/pp4.jpg')?>" alt="">
									</div>
									<div class="details">
						...
						<div class="single-sidebar-widget ads-widget">
							<a href="#"><img class="img-fluid" src="<?=base_url('img/blog/ads-banner.jpg')?>" alt=""></a>
						</div>
